      ...
      <div class="card">
        ...
        <div class="card-header">
         ...
         <div class="container-fluid">       
          <div class="row">
            <div class="col-sm-4">
              <h3 class="box-title">Mapa mensual</h3>
            </div>
            <div class="col-sm-8">
...
<script type="text/javascript">
 ...
 $(function () {
   ...
   $( "#meses" ).change(function() {
      ...
      mostrargraficoMensual(this.value );
    });


    function mostrargraficoMensual(mes) {

         $.ajax({
          type: 'post',
          url: "{{ route('mapas.showMes') }}" ,
          dataType: 'json',
          data: {
            mes: mes         
          },
          success: function (result) {
            ...
            document.getElementById("imagenMes").src = result.url;
